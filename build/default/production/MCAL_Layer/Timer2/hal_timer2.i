...
# 1 "MCAL_Layer/Timer2/../interrupt/mcal_internal_interrupts.h" 1
# 12 "MCAL_Layer/Timer2/../interrupt/mcal_internal_interrupts.h"
...
# 53 "MCAL_Layer/Timer2/../interrupt/mcal_interrupt_config.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY,
}interrupt_priority_cfg;
# 12 "MCAL_Layer/Timer2/../interrupt/mcal_internal_interrupts.h" 2
...
Std_ReturnType Timer2_Init(const timer2_t *_timer){
    ...
    if (((void*)0) == _timer){
        ...
        (T2CONbits.T2OUTPS = _timer->timer2_postscaler_value);
...
# 43 "MCAL_Layer/Timer2/hal_timer2.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
